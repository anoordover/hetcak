...
------------ | ------------- | ------------- | -------------
*RelatieApi* | [**GetRelatiesByPersoonId**](docs/RelatieApi.md#getrelatiesbypersoonid) | **GET** /personen/persoon/relaties/{persoonId}/ | Relaties bij een persoon ophalen


<a name="documentation-for-models"></a>
## Documentation for Models

 - [Model.Persoon](docs/Persoon.md)
 - [Model.Relatie](docs/Relatie.md)
 - [Model.Relaties](docs/Relaties.md)
